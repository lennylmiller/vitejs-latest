export const template = `<h1>inag-button</h1>
<p>
    Inner Agiligy (inag) buttons trigger an ink reaction on press. They may display text, imagery, or both. Flat buttons and raised
    buttons are the most commonly used types.
</p>

<h3>Usage</h3>
<pre>
    &lt;inag-button label="Confirm"&gt;
...
<section class="demo">
    ...
    <div class="demo-option">
        <em>Standard</em>
        <inag-button label="Confirm"></inag-button>
    </div>
    ...
    <div class="demo-option">
        <em>Disabled</em>
        <inag-button label="Confirm" raised disabled></inag-button>
    </div>

    <div class="demo-option">
        <em>Color</em>
        <inag-button id="blue-button" label="Confirm" raised></inag-button>
    </div>

    <div class="demo-option">
        <em>left icon</em>
        <inag-button label="Add" raised>
            <i class="material-icons" slot="left-icon">add</i>
        </inag-button>
    </div>
    ...
    <div class="demo-option">
        <em>right icon</em>
        <inag-button label="Close" raised>
            <i class="material-icons" slot="right-icon">close</i>
        </inag-button>
    </div>
