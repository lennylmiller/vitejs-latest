export const template = `<h1>inag-dialog</h1>
<p>
...
<section class="demo">
    <h3>Demo</h3>
    <inag-dialog id="standard-dialog">
        <h1 slot="header">Dialog title</h1>
        <p slot="body">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt dolorem et, eum excepturi
            ...
            ratione unde!</p>
        <div slot="footer">
            <inag-button id="close-standard" label="Close"></inag-button>
        </div>
    </inag-dialog>

    <inag-dialog id="modal-dialog" modal>
        ...
        <p slot="body">This dialog has a <code>modal</code> attribute and will <b>not</b> close when the backdrop is
            clicked</p>
        <div slot="footer">
            <inag-button id="close-modal" label="Close"></inag-button>
        </div>
    </inag-dialog>

    <inag-button id="open-standard" label="Open standard" raised></inag-button>
    <inag-button id="open-modal" label="Open modal" raised></inag-button>
</section>`;
