class InagDatepicker extends HTMLElement {
...
if(!customElements.get('inag-datepicker')) {
  customElements.define('inag-datepicker', InagDatepicker);
}

export default InagDatepicker;
