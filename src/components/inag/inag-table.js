class InagTable extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.selectAll = customElements.get('inag-checkbox')
      ? `<inag-checkbox class="select-all"></inag-checkbox>`
      : `<input type="checkbox" class="select-all">`;

    this.checkBox = customElements.get('inag-checkbox')
      ? `<inag-checkbox></inag-checkbox>`
      : `<input type="checkbox">`;

    this.checkBoxSelector = customElements.get('inag-checkbox')
      ? `inag-checkbox`
      : `input`;
  }
...
if(!customElements.get('inag-table')) {
  customElements.define('inag-table', InagTable);
}

export default InagTable;
