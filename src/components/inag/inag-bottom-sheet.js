class InagBottomSheet extends HTMLElement {
...
if(!customElements.get('inag-bottom-sheet')) {
  customElements.define('inag-bottom-sheet', InagBottomSheet);
}

export  default InagBottomSheet;
