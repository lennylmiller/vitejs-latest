class InagRadiobutton extends HTMLElement {
...
if(!customElements.get('inag-radiobutton')) {
  customElements.define('inag-radiobutton', InagRadiobutton);
}

export default InagRadiobutton;
