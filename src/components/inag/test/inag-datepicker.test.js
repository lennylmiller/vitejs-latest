import '../inag-raw-datepicker.js';

describe('inag-raw-datepicker', () => {
  let element;
  ...
  beforeEach(() => {
    element = document.createElement('inag-raw-datepicker');
  ...
  it('should pick a clicked date', () => {
    const dateString = '01-01-2023';
    const newDate = new Date('01-27-2023');
    const spy = sinon.spy(element, 'pickDate');
