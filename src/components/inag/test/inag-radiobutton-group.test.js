...
describe('inag-radiobutton-group', () => {
  let element;
  ...
  beforeEach(() => {
    element = document.createElement('inag-radiobutton-group');

    data.forEach(item => {
      const radio = document.createElement('inag-radiobutton');
  ...
  it('should set the "name" attribute on the inag-radiobutton-group to all inag-radiobuttons ', () => {
