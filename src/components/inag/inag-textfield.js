class InagTextfield extends HTMLElement {
...
if(!customElements.get('inag-textfield')) {
  customElements.define('inag-textfield', InagTextfield);
}

export default InagTextfield
