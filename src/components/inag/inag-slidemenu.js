class InagSlidemenu extends HTMLElement {
  constructor() {
    super();
...
if(!customElements.get('inag-slidemenu')) {
  customElements.define('inag-slidemenu', InagSlidemenu);
}

export default InagSlidemenu
